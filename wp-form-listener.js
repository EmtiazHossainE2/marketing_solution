(function () {
  ...
  var forms = document.querySelectorAll(
    'form[id^="wpforms-form-"]:not(.wpforms-ajax-form)'
  );
      ...
      formData.forEach(function (value, key) {
        if (key) {
          ...
          if (inputField) {
            ...
            var isRequiredField = inputField.classList.contains(
            ...
            if (isRequiredField) {
              if (inputField.tagName === "SELECT") {
                var selectedOptionVal =
                  inputField.options[inputField.selectedIndex].text;
                if (!selectedOptionVal) {
                  errorRequired = true;
                }
              } else if (
                inputField.getAttribute("type") === "email" &&
