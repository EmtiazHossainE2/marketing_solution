...
function eventLog(eventName, eventData) {
  const css1 =
    "background: red; color: #fff; font-size: normal; border-radius: 3px 0 0 3px; padding: 3px 4px;";
  const css2 =
    "background-color: blue; color: #fff; font-size: normal; border-radius: 0 3px 3px 0; padding: 3px 4px;";

  console.log(
    "%cGTM DataLayer Event:%c" + event_prefix + eventName,
    css1,
    css2,
    eventData
  );
